...
static const unsigned char MAX_NODE_NUM = 0x10u;
...
//THIS is for ExtCAN
#define MII_MSG_SPLIT_EXNODEID(msg) (((msg) & (0x07800000)) >> 23)
#define MII_MSG_SPLIT_EXMSGID(msg)  (((msg) & (0x007c0000)) >> 18)
#define MII_MSG_SPLIT_EXSWID(msg)   (((msg) & (0x00030000)) >> 16)
#define MII_MSG_SPLIT_EXSPID(msg)   ((msg) & (0x0000ffff))
...
#define MII_MSG_FILL_NODEID(msg, node_id) \
    __MII_MSG_FILL(msg, node_id, MII_MSG_SPLIT_MSGID(msg))
// Filling the msg_id into the given message
#define MII_MSG_FILL_MSGID(msg, msg_id) \
    __MII_MSG_FILL(msg, MII_MSG_SPLIT_NODEID(msg), msg_id)
